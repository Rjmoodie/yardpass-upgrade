-- Test CPM accumulation - Simple version for manual execution

-- Before status
SELECT 'BEFORE:' as stage, spent_credits, spend_accrual, total_budget_credits - spent_credits as remaining_budget
...
-- After status
SELECT 'AFTER:' as stage, spent_credits, spend_accrual, total_budget_credits - spent_credits as remaining_budget
FROM campaigns.campaigns
WHERE id = '3a51d5c9-b817-4c11-859f-5cd0b4c5b1ec';
