-- =====================================================
-- CONVERSION TRACKING - COMPLETE DEPLOYMENT
-- =====================================================
-- This script combines all conversion tracking enhancements
-- Run this in your Supabase SQL Editor
-- =====================================================

-- =====================================================
-- PART 1: ENHANCE AD_CONVERSIONS TABLE
-- =====================================================

-- Add new columns to ad_conversions
...
-- =====================================================
-- PART 2: DROP OLD FUNCTION
-- =====================================================

DROP FUNCTION IF EXISTS public.attribute_conversion CASCADE;

-- =====================================================
-- PART 3: CREATE ENHANCED ATTRIBUTE_CONVERSION
-- =====================================================
...
-- =====================================================
-- PART 6: REBUILD MATERIALIZED VIEW WITH METRICS
-- =====================================================
...
-- =====================================================
-- PART 7: UPDATE REFRESH FUNCTION
-- =====================================================
...
SELECT 
  '✅ Conversion tracking deployed successfully!' AS status,
  'Run verify-conversion-tracking.sql to confirm' AS next_step;
