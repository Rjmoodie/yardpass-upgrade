// Basic Sponsorship Page - No complex component imports
...
export const SponsorshipPageBasic: React.FC<SponsorshipPageProps> = ({
  userRole = 'organizer',
  eventId,
  sponsorId
}) => {
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold flex items-center gap-2">
          ...
          Sponsorship Platform - Basic
        </h1>
        <p className="text-muted-foreground mt-2">
          Basic version without complex component imports
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p><strong>Status:</strong> Basic version working</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
...
export default SponsorshipPageBasic;
