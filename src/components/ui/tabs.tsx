...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-[44px] h-auto items-center justify-start rounded-xl bg-muted/60 backdrop-blur-sm p-1 text-muted-foreground overflow-x-auto scrollbar-hide",
      className
    )}
    {...props}
  />
