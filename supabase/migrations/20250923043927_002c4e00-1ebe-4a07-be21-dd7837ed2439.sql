-- Drop and recreate get_home_feed_v2 to include owner_context_type for proper navigation
DROP FUNCTION IF EXISTS get_home_feed_v2(uuid, integer, timestamptz, text);
