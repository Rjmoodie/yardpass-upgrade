...
-- Unique attendees (server-side dedupe) with stable paging
...
-- Supports GROUP BY(owner_user_id) + MIN(created_at)
...
GRANT EXECUTE ON FUNCTION public.count_event_attendees(uuid) TO authenticated;
