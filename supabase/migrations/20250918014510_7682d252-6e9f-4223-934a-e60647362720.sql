-- First, let's ensure we have the proper triggers for real-time count updates
-- and set up realtime properly

-- Add the follows table to realtime publication (it was missing)
